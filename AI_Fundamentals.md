...
- [Module 4: Design great prompts](#module-4-design-great-prompts)
  ...
  - [4.3 Apply the prompting framework in Gemini（实验室）](#43-apply-the-prompting-framework-in-gemini实验室)
...
- [Module 5: Level up your prompts](#module-5-level-up-your-prompts)
  ...
  - [5.2 Practice prompt chaining in Gemini（实验室）](#52-practice-prompt-chaining-in-gemini实验室)
  ...
  - [5.5 Create custom images with Gemini（实验室）](#55-create-custom-images-with-gemini实验室)
